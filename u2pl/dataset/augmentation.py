...
class Resize(object):
    ...
    def __init__(self, size):
        assert isinstance(size, collectionsAbc.Iterable) and len(size) == 2
        self.size = size
...
class RandResize(object):
    ...
    def __init__(self, scale, aspect_ratio=None):
        assert isinstance(scale, collectionsAbc.Iterable) and len(scale) == 2
        if (
            isinstance(scale, collectionsAbc.Iterable)
            and len(scale) == 2
        ...
        if aspect_ratio is None:
            ...
            isinstance(aspect_ratio, collectionsAbc.Iterable)
...
class Crop(object):
    ...
    def __init__(self, size, crop_type="center", ignore_label=255):
        if isinstance(size, int):
            ...
            isinstance(size, collectionsAbc.Iterable)
            and len(size) == 2
...
class RandRotate(object):
    ...
    def __init__(self, rotate, ignore_label=255):
        assert isinstance(rotate, collectionsAbc.Iterable) and len(rotate) == 2
